...
const misi = [
    {id: 5, no: 1, misi: 'Mengembangkan potensi serta kemampuan mahasiswa Ilmu Komputer UGM agar terciptanya Imu Komputer yang aktif dan produktif.'},
    {id: 6, no: 2, misi: 'Meningkatkan kerjasama dan koordinasi dengan seluruh mahasiswa Ilmu Komputer UGM serta iembaga-lembaga akademik maupun non-akademik.'},
    {id: 7, no: 3, misi: 'Meningkatkan kebersamaan dengan seluruh mahasiswa Ilmu Komputer UGM.'},
    {id: 8, no: 4, misi: 'Mengoptimalkan program kerja HIMAKOM melalui observasi dan diskusi secara kemusyawaratan.'},
];
    ...
    <>
        ...
        {/* Candidates Header */}
            <div className='h-fit flex flex-col lg:flex-row justify-center timeline-bg p-10 pb-28'>
                    <div className='relative h-[100%] mr-2 mx-auto justify-center flex'>
                        ...
                        <img src={Frame}></img>
                        <h1 className='absolute z-10 text-[150px] lg:text-[300px] right-[0px] lg:right-[-30px] top-[54%] lg:top-[32%] text-white shadowm-xl '>3</h1>
                    </div>
                    ...
                    <div className='lg:w-[50%] mx-auto md:ml-6 relative flex justify-center lg:justify-start align-middle'>
                        <div className='m-auto pt-[10%] lg:pt-[25%] w-[100%]'>
                            <h1 className='text-[50px] text-center lg:text-left lg:text-[100px]
                                        lg:w-[90%] leading-[0.9] text-white uppercase'>billy fahd qodama</h1>
                            <h2 className ='text-[30px] text-center lg:pl-1 lg:text-left lg:text-[55px] text-[#D4A976] leading-none lg:leading-[0.9] py-1'>KPM</h2>
        ...
        {/* Grand Design */}
            <div className='hidden h-fit w-screen md:flex flex-col justify-center pb-20'>
                ...
                <div className='h-fit m-auto flex justify-center'>
                    <iframe className='w-[80vw] h-[75vh]' src={GD_Billy} frameBorder="0"></iframe>
                </div>
            ...
            <div className='h-fit p-12 w-screen flex flex-col relative bg-[#21201D]'>
                ...
                <div className='h-[85%] max-h-fit flex flex-col '>
                    ...
                    <div className='space-y-5 flex flex-col justify-center  mx-auto'>
                        {inovasi.map((items, i) => (
                            <div key={i} className='inovasi grid items-center px-7 md:px-14 text-center text-[13px] lg:text-[18px] '>
                                <h1>{items.data}</h1>
                            </div>
                        ))}
                    </div>
