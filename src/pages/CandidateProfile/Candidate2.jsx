  ...
  const misi = [
    {
      id: 5,
      no: 1,
      misi: "Menyelenggarakan berbagai acara internal maupun eksternal, dengan mengedepankan nilai kekeluargaan, kepekaan sosial, kreativitas, dan profesionalisme.",
    },
    {
      id: 6,
      no: 2,
      misi: "Menyediakan lingkungan dinamis yang dapat menyesuaikan dan mendukung segala aktivitas mahasiswa IImu Komputer.",
    },
    {
      id: 7,
      no: 3,
      misi: "Memperluas jaringan Himakom UGM bersama pihak luar dengan tujuan mendukung segala kegiatan yang diselenggarakan Himakom UGM.",
    },
    {
      id: 8,
      no: 4,
      misi: "Menciptakan berbagai macam inovasi mengenai keorganisasian secara umum sehingga Himakom UGM memiliki keunggulan dan mengurangi kekurangan dibanding organisasi lainnya.",
    },
  ];
        ...
        <div className='h-fit flex flex-col lg:flex-row timeline-bg p-10 pb-28'>
          <div className='relative h-[100%] mr-2 mx-auto justify-center flex'>
            <img
              src={Konang}
              alt='konang'
              className='absolute scale-110 bottom-[13%] xl:bottom-[12.5%]'
            ></img>
