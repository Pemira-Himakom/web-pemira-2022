        ...
        <div>
            ...
            <div className="w-full h-[64px] fixed top-0 z-40">
                <div className='md:flex h-[56px] place-content-end shadow-md py-4 md:px-10 px-7 font-prata bg-[#21201D]'>
                    ...
                    <ul className={`md:flex shadow-md md:shadow-none md:items-center md:pb-0 pb-4 absolute md:static bg-[#21201D] text-[#D4A976] mx-4  md:z-40 z-[-1] left-0 w-[91vw] rounded-xl md:w-auto md:pl-0 pl-9 md:pt-0 pt-9 transition-all duration-300 ease-in ${open ? 'opacity-100':'opacity-0'} md:opacity-100 text-xl`}>
                        ...
                        <li key="1" className="ml-4 md:ml-8 md:my-0 my-4 px-1 py-1 hover:text-[#ffd39c]">
                            <NavLink to="/voting" className={({isActive}) => isActive ? normalLink : normalLink} ><p title>{"Voting"}</p></NavLink>
                        </li>
